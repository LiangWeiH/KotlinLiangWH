...
public class AppUtils {
    ...
    public static void installApp(Context context, String filePath, String fileProvide) {
        context.startActivity(IntentUtils.getInstallAppIntent(context, filePath, fileProvide));
    }
    ...
    public static void installApp(Activity activity, String filePath, String fileProvide, int requestCode) {
        activity.startActivityForResult(IntentUtils.getInstallAppIntent(activity, filePath, fileProvide), requestCode);
    }
    ...
    public static void installApp(Activity activity, File file, String fileProvide, int requestCode) {
        if (!FileUtils.isFileExists(file)) return;
        installApp(activity, FileUtils.getFileByPath(file.getPath()), fileProvide, requestCode);
    }
    ...
    public static String getAppName(Context context, String packageName) {
        if (DataUtils.isNullString(packageName)) return null;
        try {
            PackageManager pm = context.getPackageManager();
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (DataUtils.isNullString(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !DataUtils.isNullString(packageName) && packageName.equals(ProcessUtils.getForegroundProcessName(context));
    }
    //----------------------------------------------------------------------------------------------------------------
