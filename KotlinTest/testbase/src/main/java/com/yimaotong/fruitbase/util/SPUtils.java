...
public class SPUtils {
    ...
    public static void putJSONCache(String key, String content) {
        SharedPreferences sp = UIUtils.getContext().getSharedPreferences(JSON_CACHE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
    ...
    public static void clearPreference(String name, String key) {
        SharedPreferences sharedPreferences = UIUtils.getContext().getSharedPreferences(name, Context.MODE_PRIVATE);
