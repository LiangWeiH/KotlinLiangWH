package com.yimaotong.fruitbase.ui.simpledialog;
...
public abstract class BaseDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = (int) (DeviceUtils.getScreenWidth(getContext()) - 2 * UIUtils.dip2px(margin));
            } else if (width == -1) {
    ...
    public BaseDialog setTop(boolean isTop){
        this.isTop =isTop;
        return this;
    }
